...
VisionApiResponseDto _$VisionApiResponseDtoFromJson(
    ...
    VisionApiResponseDto(
      responses: (json['responses'] as List<dynamic>?)
          ?.map((e) =>
              AnnotateImageResponseDto.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
...
Map<String, dynamic> _$AnnotateImageResponseDtoToJson(
    ...
    <String, dynamic>{
      'labelAnnotations':
          instance.labelAnnotations?.map((e) => e.toJson()).toList(),
      'textAnnotations':
          instance.textAnnotations?.map((e) => e.toJson()).toList(),
      'landmarkAnnotations':
          instance.landmarkAnnotations?.map((e) => e.toJson()).toList(),
      'logoAnnotations':
          instance.logoAnnotations?.map((e) => e.toJson()).toList(),
      'faceAnnotations':
...
FaceAnnotationDto _$FaceAnnotationDtoFromJson(Map<String, dynamic> json) =>
    FaceAnnotationDto(
      boundingPoly: json['boundingPoly'] == null
          ? null
          : BoundingPolyDto.fromJson(
      ...
      landMarkingConfidence:
          (json['landMarkingConfidence'] as num?)?.toDouble(),
