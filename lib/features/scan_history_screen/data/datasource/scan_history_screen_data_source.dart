...
abstract class ScanHistoryScreenDataSource {
  Future<List<ScanHistoryModel>> getScanHistory();
}

@LazySingleton(as: ScanHistoryScreenDataSource)
class ScanHistoryScreenDataSourceImpl implements ScanHistoryScreenDataSource {
  final ScanHistoryDao _scanHistoryDao = locator<ScanHistoryDao>();
  @override
